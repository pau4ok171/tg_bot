...
# TODO: Врапер для проверки версионности под хендлером
# TODO: TOP книг кнопками
# TODO: Рефакторинг хендлеров закончить

# TODO: Собрать собственный календарь
# TODO: Сделать возможным каждому пользователю видеть свою личную статистику
# TODO: С панели управления сделать возможность изменять/давать/удалять уровень доступа к пользователям
#  (Возможно добавить возможность выбирать с помощью pg)
# TODO: Рефакторинг
# 1.0.4
# TODO: Возвращать пользователя на сохр страницу в случае отмены(К книгам)
# TODO: Handler всех хандлеров для перехвата базовых элементов?
# TODO: Обнулять календарь при отмене
# TODO: Выбрасывать данные не в чат, а прописывать в сообщение над кнопкой
#  (В том числе таблицы)
# 1.0.5
...
# TODO: Из хендлеров переместить все команды в отдельный модуль
#  (В хендлерах только вызывать команды ex: cm.start_menu())
# TODO: Сделать карточку пользователей (уровень доступа, имя, id, послед дата обр ...)
# 1.0.6
# TODO: Длительность сессии в бд (лимит-1мин)
# TODO: Marquer comme lu через пагинатор
# TODO: Разделить States по календарям
# TODO: Пагинанация: ответом должна выдавать id книги. Все остальное должно делаться отдельно
